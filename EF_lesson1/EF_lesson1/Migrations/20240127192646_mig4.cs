        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Financing = table.Column<decimal>(type: "money", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CuratorGroup", x => new { x.CuratorsId, x.GroupsId });
                    table.ForeignKey(
                        name: "FK_CuratorGroup_Curator_CuratorsId",
                        column: x => x.CuratorsId,
                        principalTable: "Curator",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CuratorGroup_Groups_GroupsId",
                        column: x => x.GroupsId,
